...
class VirtualClassroomManager {
    ...
    public void generateReport(String className) {
        Classroom classroom = classrooms.get(className);
        if (classroom == null) {
            System.out.println("Classroom " + className + " does not exist.");
            return;
        ...
        System.out.println("Report for Classroom: " + className);
        System.out.println("Number of Students: " + classroom.getStudents().size());
        System.out.println("Number of Assignments: " + classroom.getAssignments().size());
        System.out.println("Students: " + classroom.listStudents());
        System.out.println("Assignments: " + classroom.listAssignments());
    }
}